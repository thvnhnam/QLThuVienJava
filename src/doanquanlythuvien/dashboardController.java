...
public class dashboardController implements Initializable {
    ...
    private String comboBox[] = {"Nam", "Nữ", "Khác"};
    ...
    public void takeBook() {
        ...
        try {
            ...
            if (take_FirstName.getText().isEmpty()
                ...
                alert.setContentText("Hãy nhập thông tin sinh viên");
                alert.showAndWait();
            } else if (take_titleLabel.getText().isEmpty()) {
                alert = new Alert(AlertType.ERROR);
                alert.setTitle("Thông báo");
                alert.setHeaderText(null);
                alert.setContentText("Hãy chọn sách muốn lấy.");
                alert.showAndWait();
            } else {
                ...
                alert.setTitle("Thông báo");
                alert.setHeaderText(null);
                alert.setContentText("Chọn sách thành công!");
                alert.showAndWait();
    ...
    public void findBook(ActionEvent event) {
        ...
        try {
            ...
            if (take_BookTitle.getText().isEmpty()) {
                ...
                alert.setTitle("Thông báo");
                alert.setHeaderText(null);
                alert.setContentText("Hãy chọn sách.");
                alert.showAndWait();
                ...
                if (!check) {
                    take_titleLabel.setText("Sách đã hết!");
...
//    RETURN FORM
    ...
    public void returnBooks() {
        ...
        try {
            ...
            if (return_imageView.getImage() == null) {
                ...
                alert.setTitle("Thông báo");
                alert.setHeaderText(null);
                alert.setContentText("Hãy chọn sách muốn trả");
                alert.showAndWait();
    ...
    public void unsaveBooks() {
        ...
        try {
            ...
            if (save_imageView.getImage() == null) {
                ...
                alert.setTitle("Thông báo");
                alert.setHeaderText(null);
                alert.setContentText("Hãy chọn sách muốn bỏ lưu");
                alert.showAndWait();
    ...
    public void abTakeButton(ActionEvent event) {
        ...
        if (event.getSource() == take_btn) {
            ...
            currentForm_label.setText("Mượn sách");
    ...
    public void sideNavButtonDesign(ActionEvent event) {
        ...
        if (event.getSource() == halfNav_availableBtn) {
            ...
            currentForm_label.setText("Sách có sẵn");
            ...
            currentForm_label.setText("Trả sách");
            ...
            currentForm_label.setText("Sách đã lưu");
